...
export const FORMATOS: Formato[] = [
  {
    ...
    campos: [
      ...
      { id: 'publico', etiqueta: 'A quién le habla', tipo: 'texto', ayuda: 'Edad, zona, qué problema tiene. Ej. mujeres de 25 a 40 en Medellín con piel sensible.' },
  ...
  },
  {
    ...
    campos: [
      ...
      { id: 'que_decir', etiqueta: 'Qué les quiere decir', tipo: 'texto', ayuda: 'La idea. Ej. volvió el serum que se había agotado.' },
