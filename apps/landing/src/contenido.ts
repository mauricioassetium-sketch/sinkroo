...
export type Contenido = {
  ...
  comoLoHacemos: {
    ...
    etapas: Etapa[];
    /** La firma del cierre: las palabras del dibujo de Dubai, arriba a la izquierda. El corazón NO va
     *  acá: es un elemento aparte (late y va en morado), y se arma en `Landing.tsx`. */
    dubaiFirma: string;
  };
  /* 6 · CON QUÉ TRABAJA */
